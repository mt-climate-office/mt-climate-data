...
write.dir = "/home/zhoylman/mt-climate-data/data/temperature/annual_sum/"

mt = read_sf("/home/zhoylman/mt-climate-data/shp/states/states.shp")%>%
  filter(STATE_ABBR == "MT")

precip = brick("http://thredds.northwestknowledge.net:8080/thredds/dodsC/agg_met_tmmn_1979_CurrentYear_CONUS.nc", 
